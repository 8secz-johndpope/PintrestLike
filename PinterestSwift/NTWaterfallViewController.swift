...
//    class var sharedInstance: NSInteger = 0 Are u kidding me?
   ...
   // let delegateHolder = NavigationControllerDelegate()
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath){
        ...
        self.navigationController!.delegate = pageViewController
    ...
    func pageViewControllerLayout () -> UICollectionViewFlowLayout {
        ...
        let itemSize  = self.navigationController!.isNavigationBarHidden ?
                    CGSize(width: screenWidth, height: screenHeight+20) :
    ...
    func viewWillAppearWithPageIndex(_ pageIndex : NSInteger) {
        var position : UICollectionViewScrollPosition = UICollectionViewScrollPosition.centeredHorizontally.intersection(.centeredVertically)
